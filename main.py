...
def greetings():
    print("Greetings Angel! Let's read some beautiful lyrics now?")
    ...
    if greetings():
        while True:
            ...
            if song_list:
                ...
                try:
                    selected_song_index = int(input("Enter the number of the song you want to see the lyrics for: ")) - 1
            ...
            artworks_response = input("Do you want to see the artwork? (yes/no): ").lower()
